...
* Определение единиц измерения для каждого показателя: 1 - Binary unit. Аудитор либо получает доступ в сеть (1), либо нет (0). 2 - Отклонение от предварительно известого значения скорости сети, выраженное в процентном соотношении.
